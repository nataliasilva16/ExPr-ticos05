...
# Definindo cores
azul = (0, 0, 255)  # Cor da cobrinha alterada para azul
vermelho = (255, 0, 0)
preto = (0, 0, 0)

# Configurações do jogo
tamanho_celula = 20
velocidade = 5  # Velocidade da cobrinha alterada para 5
...
def desenhar_cobrinha(cobra):
    for parte in cobra:
        pygame.draw.rect(tela, azul, (parte[0], parte[1], tamanho_celula, tamanho_celula))  # Desenho da cobrinha azul
