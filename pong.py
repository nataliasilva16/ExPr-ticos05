...
azul = (0, 128, 255)
verde = (0, 255, 0)
vermelho = (255, 0, 0)  # Nova cor vermelha para a raquete da direita
amarelo = (255, 255, 0)

# Posições e velocidades iniciais das raquetes e bola
raquete_largura = 10
raquete_altura = 100
raquete_esquerda_y = altura // 2 - raquete_altura // 2
raquete_direita_y = altura // 2 - raquete_altura // 2
raquete_direita_x = largura - raquete_largura - 20
